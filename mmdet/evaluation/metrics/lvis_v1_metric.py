...
try:
    ...
    if getattr(lvis, '__version__', '0') >= '10.5.3':
        warnings.warn(
            ...
            UserWarning)
    from mmdet.datasets.api_wrappers.lvis_api import LVIS
...
class LVISV1Metric(CocoMetric):
    ...
    def compute_metrics(self, results: list) -> Dict[str, float]:
        ...
        if self.cat_ids is None:
            self.cat_ids = self._lvis_api.get_cat_ids(cat_names=self.dataset_meta["classes"])
